      ...
      <div className="page_wrapper">
        ...
        <div className="footer">
          <div className="container standart">
            <div className="row standart first_footer">
              <div className="contact col-md-4">
                <h4>Contact</h4>
                <h5>lenka.varchuk@gmail.com</h5>
                <h5>+(380)50-685-76-43</h5>
              </div>
